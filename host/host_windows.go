...
import (
	...
	process "github.com/blastbao/gopsutil/process"
...
func getMachineGuid() (string, error) {
	// there has been reports of issues on 32bit using golang.org/x/sys/windows/registry, see https://github.com/blastbao/gopsutil/pull/312#issuecomment-277422612

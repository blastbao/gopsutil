...
import (
	...
	cpu "github.com/blastbao/gopsutil/cpu"
	"github.com/blastbao/gopsutil/internal/common"
	mem "github.com/blastbao/gopsutil/mem"
	net "github.com/blastbao/gopsutil/net"
...
func (p *Process) ForegroundWithContext(ctx context.Context) (bool, error) {
	// see https://github.com/blastbao/gopsutil/issues/596#issuecomment-432707831 for implementation details
	pid := p.Pid
